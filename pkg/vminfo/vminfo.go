...
func (checker *Checker) Capabilities(fileInfos []*flatrpc.FileInfo) *Capabilities {
...
func (nopChecker) capabilities(files filesystem) *Capabilities {
	return nil
}
