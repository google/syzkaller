...
func newStats(target *prog.Target) Stats {
	return Stats{
		...
		statJobsHints: stat.New("hints jobs", "Running hints jobs", stat.StackedGraph("jobs"),
			stat.Link("/jobs?type="+string(JobHints))),
