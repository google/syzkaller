...
type ConnectReplyRawT struct {
	...
	ProcRestartFreq  int32    `json:"proc_restart_freq"`
...
func (t *ConnectReplyRawT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConnectReplyRawAddProcRestartFreq(builder, t.ProcRestartFreq)
...
func (rcv *ConnectReplyRaw) UnPackTo(t *ConnectReplyRawT) {
	...
	t.ProcRestartFreq = rcv.ProcRestartFreq()
...
func (rcv *ConnectReplyRaw) ProcRestartFreq() int32 {
...
func (rcv *ConnectReplyRaw) MutateProcRestartFreq(n int32) bool {
...
func ConnectReplyRawAddProcRestartFreq(builder *flatbuffers.Builder, procRestartFreq int32) {
	builder.PrependInt32Slot(8, procRestartFreq, 0)
}
