...
func defineList(p, mmapProg *prog.Prog, opts Options) (defines []string) {
	...
	enabled := map[string]bool{
		...
		"SYZ_ENABLE_NETDEV_DEVTYPES":    opts.EnableNetdevTypes,
		"SYZ_ENABLE_NETDEV_DEVNAMES":    opts.EnableNetdevNames,
		"SYZ_ENABLE_NETDEV_DEVMASTERS":  opts.EnableNetdevMasters,
		"SYZ_ENABLE_NETDEV":             opts.EnableNetdevTypes || opts.EnableNetdevNames || opts.EnableNetdevMasters,
