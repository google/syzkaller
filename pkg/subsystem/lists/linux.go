...
// Commit dd5a440a31fae6e459c0d6271dddd62825505361, "Linux 6.9-rc7"
...
func subsystems_linux() []*Subsystem {
	...
	coco = Subsystem{
		...
		Maintainers: []string{"kirill.shutemov@linux.intel.com"},
	...
	gpio = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^drivers/gpio/gpio-elkhartlake\\.c$|^drivers/gpio/gpio-ich\\.c$|^drivers/gpio/gpio-merrifield\\.c$|^drivers/gpio/gpio-ml-ioh\\.c$|^drivers/gpio/gpio-pch\\.c$|^drivers/gpio/gpio-sch\\.c$|^drivers/gpio/gpio-sodaville\\.c$|^drivers/gpio/gpio-tangier\\.c$|^drivers/gpio/gpio-tangier\\.h$"},
	...
	intelgfx = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^drivers/gpu/drm/i915/display/|^drivers/gpu/drm/xe/display/|^drivers/gpu/drm/xe/compat-i915-headers$"},
	...
	intelxe = Subsystem{
		...
		Maintainers: []string{"lucas.demarchi@intel.com", "ogabbay@kernel.org", "thomas.hellstrom@linux.intel.com"},
		Parents:     []*Subsystem{&dri},
		PathRules: []PathRule{
			{IncludeRegexp: "^drivers/gpu/drm/i915/display/|^drivers/gpu/drm/xe/display/|^drivers/gpu/drm/xe/compat-i915-headers$"},
			{IncludeRegexp: "^drivers/gpu/drm/xe/|^include/drm/xe[^/]*$|^include/uapi/drm/xe_drm\\.h$"},
		},
	}
	...
	lsm = Subsystem{
		...
		PathRules: []PathRule{
			...
			{"^include/uapi/linux/lsm\\.h$|^security/", "^security/selinux/"},
	...
	media = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^drivers/media/i2c/ar[^/]*$|^drivers/media/i2c/gc[^/]*$|^drivers/media/i2c/hi[^/]*$|^drivers/media/i2c/imx[^/]*$|^drivers/media/i2c/mt[^/]*$|^drivers/media/i2c/og[^/]*$|^drivers/media/i2c/ov[^/]*$|^drivers/media/i2c/s5[^/]*$|^drivers/media/i2c/st-vgxy61\\.c$"},
