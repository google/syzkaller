...
// Commit 89be9a83ccf1f88522317ce02f854f30d6115c41, "Linux 6.16-rc7"
...
func subsystems_linux() []*Subsystem {
	...
	bcachefs = Subsystem{
		Name:        "bcachefs",
		Syscalls:    []string{"syz_mount_image$bcachefs"},
	...
	kernel = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^include/linux/cpu\\.h$|^include/linux/cpuhotplug\\.h$|^include/linux/smpboot\\.h$|^kernel/cpu\\.c$|^kernel/smpboot\\.[^/]*$|^rust/helper/cpu\\.c$|^rust/kernel/cpu\\.rs$"},
	...
	mm = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^fs/hugetlbfs/|^include/linux/hugetlb\\.h$|^include/trace/events/hugetlbfs\\.h$|^mm/hugetlb\\.c$|^mm/hugetlb_cgroup\\.c$|^mm/hugetlb_cma\\.c$|^mm/hugetlb_cma\\.h$|^mm/hugetlb_vmemmap\\.c$|^mm/hugetlb_vmemmap\\.h$"},
			...
			{IncludeRegexp: "^include/linux/compaction\\.h$|^include/linux/gfp\\.h$|^include/linux/page-isolation\\.h$|^mm/compaction\\.c$|^mm/debug_page_alloc\\.c$|^mm/fail_page_alloc\\.c$|^mm/page_alloc\\.c$|^mm/page_ext\\.c$|^mm/page_frag_cache\\.c$|^mm/page_isolation\\.c$|^mm/page_owner\\.c$|^mm/page_poison\\.c$|^mm/page_reporting\\.c$|^mm/show_mem\\.c$|^mm/shuffle\\.c$"},
			{IncludeRegexp: "^include/linux/damon\\.h$|^include/trace/events/damon\\.h$|^mm/damon/"},
			{IncludeRegexp: "^include/linux/execmem\\.h$|^mm/execmem\\.c$"},
			{IncludeRegexp: "^include/linux/gfp\\.h$|^include/linux/gfp_types\\.h$|^include/linux/memory_hotplug\\.h$|^include/linux/memory-tiers\\.h$|^include/linux/mempolicy\\.h$|^include/linux/mempool\\.h$|^include/linux/memremap\\.h$|^include/linux/mmzone\\.h$|^include/linux/mmu_notifier\\.h$|^include/linux/pagewalk\\.h$|^include/trace/events/ksm\\.h$|^mm/|include/linux/page[-_]*"},
			...
			{IncludeRegexp: "^include/trace/events/mmap\\.h$|^mm/mincore\\.c$|^mm/mlock\\.c$|^mm/mmap\\.c$|^mm/mprotect\\.c$|^mm/mremap\\.c$|^mm/mseal\\.c$|^mm/msync\\.c$|^mm/nommu\\.c$|^mm/vma\\.c$|^mm/vma\\.h$|^mm/vma_exec\\.c$|^mm/vma_init\\.c$|^mm/vma_internal\\.h$"},
	...
	scsi = Subsystem{
		...
		PathRules: []PathRule{
			...
			{IncludeRegexp: "^drivers/scsi/|^drivers/ufs/|^include/scsi/|^include/uapi/scsi/"},
			{IncludeRegexp: "^drivers/target/sbp/"},
