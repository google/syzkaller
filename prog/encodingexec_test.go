...
sendmsg$nl_xfrm(r0, &(0x7f0000000240)={0x0, 0x0, &(0x7f0000000080)={&(0x7f00000001c0)=ANY=[], 0x33fe0}}, 0x0)`,
			...
			[]byte{
				...
				0xce, 0xfa, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, // Pointer placeholder for `addr`
				0x00, 0x00, 0x00, 0x00, // `addrlen` = 4 bytes
				0x00, 0x00, 0x00, 0x00, // `pad` = 4 bytes
				0xce, 0xfa, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, // Pointer placeholder for `vec`
				...
				// Payload for region 2 (empty array) is zero-length
			},
		},
	}
