...
sendmsg$nl_xfrm(r0, &(0x7f0000000240)={0x0, 0x0, &(0x7f0000000080)={&(0x7f00000001c0)=ANY=[], 0x33fe0}}, 0x0)`,
			...
			[]any{
				...
				uint32(0), uint32(0x00), kFuzzTestNilPtrVal,
...
func testOne(t *testing.T, tc testCase) {
	...
	checkSection(t, "Region Array", gotRegionArray, wantRegionArray)
	checkSection(t, "Relocation Table", gotRelocTable, wantRelocTable)
	checkSection(t, "Payload", gotPayload, wantPayload)
}
