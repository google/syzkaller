...
//line NONE:1
	...
	case 3:
	{( lex.p) = ( lex.te) - 1
out.val_int, _ = strconv.ParseInt(string(lex.data[lex.ts : lex.te]), 10, 64); tok = INT;{( lex.p)++;  lex.cs = 157; goto _out }}
	case 4:
	{( lex.p) = ( lex.te) - 1
out.val_double, _ = strconv.ParseFloat(string(lex.data[lex.ts : lex.te]), 64); tok= DOUBLE; {( lex.p)++;  lex.cs = 157; goto _out }}
	case 8:
	{( lex.p) = ( lex.te) - 1
tok = NULL; {( lex.p)++;  lex.cs = 157; goto _out }}
	case 9:
	{( lex.p) = ( lex.te) - 1
out.data = string(lex.data[lex.ts:lex.te]); tok = FLAG; {( lex.p)++;  lex.cs = 157; goto _out }}
	case 11:
	{( lex.p) = ( lex.te) - 1
out.data = string(lex.data[lex.ts:lex.te]); tok = IDENTIFIER;{( lex.p)++;  lex.cs = 157; goto _out }}
	case 36:
	{( lex.p) = ( lex.te) - 1
tok = COMMA;{( lex.p)++;  lex.cs = 157; goto _out }}
	}
...
//line straceLex.rl:79
 lex.te = ( lex.p)+1
{tok = UNFINISHED; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr30:
//line straceLex.rl:91
 lex.te = ( lex.p)+1
{tok = RBRACKET;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr36:
...
( lex.p) = ( lex.te) - 1
{out.data = string(lex.data[lex.ts:lex.te]); tok = DATETIME; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr74:
//line straceLex.rl:81
 lex.te = ( lex.p)+1
{out.data = string(lex.data[lex.ts : lex.te]); tok = MAC; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr78:
//line straceLex.rl:97
 lex.te = ( lex.p)+1
{tok = LSHIFT; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr94:
//line straceLex.rl:80
( lex.p) = ( lex.te) - 1
{tok = RESUMED; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr95:
//line straceLex.rl:80
 lex.te = ( lex.p)+1
...
//line straceLex.rl:98
 lex.te = ( lex.p)+1
{tok = RSHIFT; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr165:
...
//line straceLex.rl:95
 lex.te = ( lex.p)+1
{tok = NOT;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr170:
//line straceLex.rl:84
 lex.te = ( lex.p)+1
{tok = LPAREN;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr171:
//line straceLex.rl:86
 lex.te = ( lex.p)+1
{tok = RPAREN;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr172:
//line straceLex.rl:89
 lex.te = ( lex.p)+1
{tok = TIMES; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr173:
//line straceLex.rl:105
 lex.te = ( lex.p)+1
{tok = PLUS; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr183:
//line straceLex.rl:109
 lex.te = ( lex.p)+1
{tok = QUESTION; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr187:
//line straceLex.rl:87
 lex.te = ( lex.p)+1
{tok = LBRACKET_SQUARE;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr188:
//line straceLex.rl:88
 lex.te = ( lex.p)+1
{tok = RBRACKET_SQUARE;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr190:
//line straceLex.rl:90
 lex.te = ( lex.p)+1
{tok = LBRACKET;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr192:
//line straceLex.rl:96
 lex.te = ( lex.p)+1
{tok = ONESCOMP; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr193:
//line straceLex.rl:74
 lex.te = ( lex.p)
( lex.p)--
{out.data = ParseString(string(lex.data[lex.ts+1:lex.te-1])); tok = STRING_LITERAL;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr194:
//line straceLex.rl:94
 lex.te = ( lex.p)
( lex.p)--
{tok = AND;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr195:
//line straceLex.rl:102
 lex.te = ( lex.p)+1
{tok = LAND;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr196:
...
//line straceLex.rl:104
 lex.te = ( lex.p)
( lex.p)--
{tok = MINUS; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr200:
//line straceLex.rl:99
 lex.te = ( lex.p)+1
{tok = ARROW; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr201:
//line straceLex.rl:106
 lex.te = ( lex.p)
( lex.p)--
{tok = FORWARDSLASH; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr202:
...
//line straceLex.rl:73
 lex.te = ( lex.p)
( lex.p)--
{out.val_uint, _ = strconv.ParseUint(string(lex.data[lex.ts:lex.te]), 0, 64); tok = UINT;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr228:
//line straceLex.rl:80
 lex.te = ( lex.p)
...
//line straceLex.rl:82
 lex.te = ( lex.p)
( lex.p)--
{tok = EQUALS;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr231:
//line straceLex.rl:83
 lex.te = ( lex.p)+1
{tok = LEQUAL; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr232:
...
//line straceLex.rl:85
 lex.te = ( lex.p)+1
{tok = EQUALAT; {( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr238:
...
//line straceLex.rl:92
 lex.te = ( lex.p)
( lex.p)--
{tok = OR;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
tr257:
//line straceLex.rl:101
 lex.te = ( lex.p)+1
{tok = LOR;{( lex.p)++;  lex.cs = 157; goto _out }}
	goto st157
	st157:
//line NONE:1
 lex.ts = 0
