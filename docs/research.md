...
* [Hydra: Finding Semantic Bugs in File Systems with an Extensible Fuzzing Framework](https://compsec.postech.ac.kr/assets/publications/kim:hydra.pdf) ([github](https://github.com/sslab-gatech/hydra))
