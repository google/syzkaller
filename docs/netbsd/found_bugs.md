...
- connect(2): missing length check in some protocols causes a out of bounds read (Detected with KASan) - [fix](https://github.com/NetBSD/src/commit/a6926e46f91619f5a231a35b7886dd6c54a65ab3)
- send(2): missing length check in some protocols causes a out of bounds read (Detected with KASan) - [fix](https://github.com/NetBSD/src/commit/9e1867da2eb8366dbff200011724a66a4da24503)
