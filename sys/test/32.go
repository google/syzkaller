...
var structDescs_32 = []*KeyedStruct{
	...
	{Key: StructKey{Name: "syz_regression0_struct", Dir: 2}, Desc: &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_regression0_struct", TypeSize: 4, ArgDir: 2}, Fields: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "buffer", FldName: "f0", TypeSize: 4, ArgDir: 2}, Type: &BufferType{TypeCommon: TypeCommon{ArgDir: 1}}},
	}}},
...
var syscalls_32 = []*Syscall{
	...
	{ID: 8, Name: "mutate7", CallName: "mutate7", Args: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Type: &BufferType{TypeCommon: TypeCommon{TypeName: "string"}, Kind: 2}},
...
const revision_32 = "cedc2016e286bbf40c6139517be44a4da4597d76"
