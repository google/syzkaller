...
func init() {
	RegisterTarget(&Target{OS: "test", Arch: "32_fork_shmem", Revision: revision_32_fork_shmem, PtrSize: 4, PageSize: 4096, NumPages: 4096, DataOffset: 536870912, Syscalls: syscalls_32_fork_shmem, Resources: resources_32_fork_shmem, Structs: structDescs_32_fork_shmem, Types: types_32_fork_shmem, Consts: consts_32_fork_shmem}, InitTarget)
}
...
var structDescs_32_fork_shmem = []*KeyedStruct{
	...
	{StructKey{Name: "len_expr1"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "len_expr1", TypeSize: 56}, Fields: []Type{
		Ref(478),
		Ref(254),
	}}},
	{StructKey{Name: "len_expr2"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "len_expr2", TypeSize: 52}, Fields: []Type{
		Ref(479),
		Ref(480),
		Ref(76),
		Ref(435),
	...
	{StructKey{Name: "syz_recur_0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_0", TypeSize: 4}, Fields: []Type{
		Ref(350),
	}}},
	{StructKey{"syz_recur_0", 2}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_0", TypeSize: 4, ArgDir: 2}, Fields: []Type{
		Ref(350),
	}}},
	{StructKey{Name: "syz_recur_1"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_1", TypeSize: 8}, Fields: []Type{
		Ref(351),
		Ref(416),
	}}},
	{StructKey{"syz_recur_1", 2}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_1", TypeSize: 8, ArgDir: 2}, Fields: []Type{
		Ref(351),
		Ref(416),
	}}},
	{StructKey{Name: "syz_recur_2"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_2", TypeSize: 24}, Fields: []Type{
		Ref(350),
		Ref(415),
		Ref(425),
		Ref(427),
	...
	{StructKey{"syz_recur_2", 2}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_2", TypeSize: 24, ArgDir: 2}, Fields: []Type{
		Ref(350),
		Ref(415),
		Ref(425),
		Ref(427),
	...
	{StructKey{Name: "syz_recur_2_0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_recur_2_0", TypeSize: 16}, Fields: []Type{
		Ref(352),
		Ref(417),
		Ref(425),
		Ref(427),
	}}},
	{StructKey{"syz_regression0_struct", 2}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_regression0_struct", TypeSize: 4, ArgDir: 2}, Fields: []Type{
		Ref(433),
	}}},
...
var types_32_fork_shmem = []Type{
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(22)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(36)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(43)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(44)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(45)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(88)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(167)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(314)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(329)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(458)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(471)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(483)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(487)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(488)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(499)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(500)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(501)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(620)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(245)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(600)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(609)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(610)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(612)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(7)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(36)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(43)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(47)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(48)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(49)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(50)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(201)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(450)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(465)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(466)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(467)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(468)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(469)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(476)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(477)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(498)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(502)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(503)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(504)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(507)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(510)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(512)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(515)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(516)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(518)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(519)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(520)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(544)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(546)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(572)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(575)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(576)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(577)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(579)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(580)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(581)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(585)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(586)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(587)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(588)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(589)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(591)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(592)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(593)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(596)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(597)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(598)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(599)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(600)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(601)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(602)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(603)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(606)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(607)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(614)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(617)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(618)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(619)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(625)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(631)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(315)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(610)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(611)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(612)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(9)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(20)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(75)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(315)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(452)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(475)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(632)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a2", TypeSize: 4, IsOptional: true}, Ref(612)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a2", TypeSize: 4}, Ref(267)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a3", TypeSize: 4, IsOptional: true}, Ref(612)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a4", TypeSize: 4, IsOptional: true}, Ref(611)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a5", TypeSize: 4, IsOptional: true}, Ref(611)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "b", TypeSize: 4}, Ref(36)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "b", TypeSize: 4}, Ref(474)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "data", TypeSize: 4}, Ref(36)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f0", TypeSize: 4}, Ref(22)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f1", TypeSize: 4, IsOptional: true}, Ref(237)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f23", TypeSize: 4}, Ref(481)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f24", TypeSize: 4}, Ref(447)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f3", TypeSize: 4}, Ref(170)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "filename", TypeSize: 4}, Ref(39)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "got", TypeSize: 4}, Ref(623)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(21)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(22)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(628)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "text", TypeSize: 4}, Ref(51)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "vec", TypeSize: 4}, Ref(8)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "vec", TypeSize: 4}, Ref(10)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "want", TypeSize: 4}, Ref(43)},
	&PtrType{TypeCommon{TypeName: "ptr", TypeSize: 4}, Ref(481)},
...
const revision_32_fork_shmem = "1863b063de5b063b4a5cb38e29f65ad2f36f6cce"
