...
var structDescs_32_shmem = []*KeyedStruct{
	{StructKey{Name: "align0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "align0", TypeSize: 20}, Fields: []Type{
		Ref(98),
		Ref(77),
		Ref(139),
		Ref(220),
	...
	{StructKey{Name: "len_nontemp5"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "len_nontemp5", TypeSize: 20}, Fields: []Type{
		Ref(483),
		Ref(482),
	}}},
	...
	{StructKey{Name: "len_temp3[int64]"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "len_temp3[int64]", TypeSize: 12}, Fields: []Type{
		Ref(179),
		Ref(479),
	}}},
	...
	{StructKey{Name: "offsetof0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "offsetof0", TypeSize: 64}, Fields: []Type{
		Ref(132),
		Ref(217),
		Ref(76),
		Ref(110),
	...
	{StructKey{Name: "syz_align0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_align0", TypeSize: 20}, Fields: []Type{
		Ref(98),
		Ref(77),
		Ref(139),
		Ref(220),
	...
	{StructKey{Name: "syz_bf_align[syz_bf_struct10]"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_bf_align[syz_bf_struct10]", TypeSize: 16}, Fields: []Type{
		Ref(215),
		Ref(78),
		Ref(544),
	}}},
	...
	{StructKey{Name: "syz_bf_align[syz_bf_struct20]"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_bf_align[syz_bf_struct20]", TypeSize: 8}, Fields: []Type{
		Ref(215),
		Ref(78),
		Ref(556),
	}}},
	...
	{StructKey{Name: "syz_bf_struct10"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_bf_struct10", TypeSize: 12}, Fields: []Type{
		Ref(134),
		Ref(142),
		Ref(148),
		Ref(185),
	...
	{StructKey{Name: "syz_bf_struct20"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_bf_struct20", TypeSize: 4}, Fields: []Type{
		Ref(215),
		Ref(217),
		Ref(184),
		Ref(150),
	...
	{StructKey{Name: "syz_length_bytesize2_struct"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_length_bytesize2_struct", TypeSize: 12}, Fields: []Type{
		Ref(175),
		Ref(248),
		Ref(266),
		Ref(270),
	...
	{StructKey{Name: "syz_length_vma_struct"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_length_vma_struct", TypeSize: 12}, Fields: []Type{
		Ref(634),
		Ref(290),
	}}},
	...
	{StructKey{Name: "syz_struct0"}, &StructDesc{TypeCommon: TypeCommon{TypeName: "syz_struct0", TypeSize: 12}, Fields: []Type{
		Ref(175),
		Ref(612),
		Ref(78),
	}}},
...
var syscalls_32_shmem = []*Syscall{
	...
	{Name: "fallback$0", CallName: "fallback", MissingArgs: 1, Ret: Ref(453)},
	...
	{Name: "test$missing_resource", CallName: "test", MissingArgs: 6, Ret: Ref(457)},
	...
	{Name: "test$res0", CallName: "test", MissingArgs: 6, Ret: Ref(459)},
	{Name: "test$res1", CallName: "test", MissingArgs: 5, Args: []Type{
		Ref(458),
	}},
	{Name: "test$res2", CallName: "test", MissingArgs: 6, Ret: Ref(453)},
...
var types_32_shmem = []Type{
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "arr16be", IsVarlen: true}, Type: Ref(129)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "f1", IsVarlen: true}, Type: Ref(126), Kind: 1, RangeEnd: 3},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "f1", IsVarlen: true}, Type: Ref(167)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "f2", IsVarlen: true}, Type: Ref(167), Kind: 1, RangeEnd: 4},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "f5", IsVarlen: true}, Type: Ref(126)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "f6", IsVarlen: true}, Type: Ref(469)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", FldName: "nla", IsVarlen: true}, Type: Ref(621)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}, Type: Ref(36)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}, Type: Ref(166)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}, Type: Ref(610)},
	&ArrayType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}, Type: Ref(613)},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f0", TypeSize: 16}, Ref(198), 1, 2, 2},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f0", TypeSize: 2}, Ref(126), 1, 1, 1},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f0", TypeSize: 8}, Ref(126), 1, 4, 4},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f1", IsVarlen: true}, Ref(623), 1, 1, 2},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f1", TypeSize: 80}, Ref(198), 1, 10, 10},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f2", TypeSize: 16}, Ref(592), 1, 1, 1},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f2", TypeSize: 32, ArgDir: 2}, Ref(165), 1, 8, 8},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f2", TypeSize: 32}, Ref(167), 1, 8, 8},
	&ArrayType{TypeCommon{TypeName: "array", FldName: "f3", TypeSize: 12}, Ref(167), 1, 3, 3},
	&ArrayType{TypeCommon{TypeName: "array", TypeSize: 16}, Ref(167), 1, 4, 4},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(85)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(164)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(311)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(326)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(455)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(468)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(480)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(484)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(485)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(496)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(497)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(498)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Ref(617)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(242)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(597)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(606)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4, IsOptional: true}, Ref(607)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(198)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(447)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(462)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(463)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(464)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(473)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(474)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(495)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(499)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(500)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(501)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(509)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(512)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(513)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(517)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(541)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(543)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(569)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(572)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(573)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(574)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(578)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(582)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(583)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(584)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(590)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(593)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(594)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(595)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(604)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(611)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(614)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(615)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(616)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(622)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Ref(628)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(312)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(607)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(608)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4, IsOptional: true}, Ref(609)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(312)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(449)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(472)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a1", TypeSize: 4}, Ref(629)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a2", TypeSize: 4, IsOptional: true}, Ref(609)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a2", TypeSize: 4}, Ref(264)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a3", TypeSize: 4, IsOptional: true}, Ref(609)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a4", TypeSize: 4, IsOptional: true}, Ref(608)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "a5", TypeSize: 4, IsOptional: true}, Ref(608)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "b", TypeSize: 4}, Ref(36)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "b", TypeSize: 4}, Ref(471)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f1", TypeSize: 4, IsOptional: true}, Ref(234)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f23", TypeSize: 4}, Ref(478)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f24", TypeSize: 4}, Ref(444)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "f3", TypeSize: 4}, Ref(167)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "filename", TypeSize: 4}, Ref(39)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "got", TypeSize: 4}, Ref(620)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(21)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(22)},
	&PtrType{TypeCommon{TypeName: "ptr", FldName: "p", TypeSize: 4}, Ref(625)},
	...
	&PtrType{TypeCommon{TypeName: "ptr", TypeSize: 4}, Ref(478)},
	&PtrType{TypeCommon{TypeName: "ptr64", FldName: "f3", TypeSize: 8, IsOptional: true}, Ref(234)},
...
const revision_32_shmem = "b76d0e05e255397a7e1c718e8313ee85a365d996"
