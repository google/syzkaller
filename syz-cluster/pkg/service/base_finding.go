...
// Package service implements high-level business logic services,
// including patch series processing, build management, testing sessions, job execution, and reporting.
package service
