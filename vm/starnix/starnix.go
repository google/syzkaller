...
func (inst *instance) restartDaemon() {
	if inst.debug {
		log.Logf(0, "restarting daemon")
	}
	osutil.RunCmd(1*time.Minute*inst.timeouts.Scale, inst.fuchsiaDirectory, "ffx", "doctor", "--restart-daemon")
}
